...
**Cirrus** is a minimal Linux system that boots a `bzImage` kernel with an `initramfs.gz` directly using QEMU, without creating an ISO or disk image.But if you want to make it an iso
